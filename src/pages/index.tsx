    ...
    <div className="block">
      ...
      <section id="sec-2">
        <div className="flex w-full item-center px-[5%] ">
          <div className="w-[65%]">
            <p className="text-[1.5vw] font-bold">IT'S MORE THAN THAT THOUGH</p>
            <div className="relative w-full flex justify-between">
              <Image
                className="absolute h-auto -left-[5vw] w-[5vw] aspect-[3/13] overflow-clip"
              ...
              />
              <div className="mt-[2.5vw] px-[5vw]">
                <p>
                  We are The Dockyard Social.
                  <br />
                  <br />
                  We’ve switched from popups to permanent. Now we’re bringing
                  together the best street food traders Scotland has to offer. A
                  true taste of Global comfort food. Throw in some watermelon
                  daiquiris, a dollop of old school tunes, with a pinch of
                  likeminded people, and dance ‘til your paws hurt!
                  <br />
                  <br />
      ...
      <section id="sec-3" className="min-h-screen "></section>
      <section id="sec-4" className="min-h-screen "></section>
    </div>
  );
};
